...
import flogica.f_sucursal;
import static frminicio.frmaccesorios.jTfcantidad;
import java.io.File;
...
public class frmsucursal extends javax.swing.JInternalFrame {
    ...
    void mostrar(String buscar) {
        try {
            ...
            f_sucursal func = new f_sucursal();
            
            f_departamento fp = new f_departamento();
...
//            fe.cargarComboEstados(jCBEstado);
           fp.cargarComboDepartamento(jCBdepa);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Sucursal"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(jTdire, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(jLPiso, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jCBdepa, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(24, 24, 24))
                            .addComponent(jTFidhabitacion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Sucursal Guardados"));
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        ...
        if (jTFnombre.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar un Nombre del Sucursal");
            jTFnombre.requestFocus();
            return;
        }
        if (jTdire.getText().length() == 0) {
        ...
        dts.setDireccion(jTdire.getText());
        dts.setTelefono(Integer.parseInt(jTtelefono.getText()));
        int seleccionado = jCBdepa.getSelectedIndex();
        dts.setIdDepartamento(fp.obtenerIdDepartamento(jCBdepa));
       ...
       // dts.setIdtipohabitacion(fh.obtenerIdtipohabitacion(jCBTipoHabitacion));
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "El Sucursal fue registrada satisfactoriamete!");
                mostrar("");
                inhabilitar();
            }
            ...
            if (func.editar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "El Sucursal  fue editada satisfactoriamente!");
                mostrar("");
                inhabilitar();
            }
        }
    ...
    private void jBEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarActionPerformed
        ...
        if (!jTFidhabitacion.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Estas seguro de eliminar la Sucursal?", "Confirmar", 2);
    ...
    private void jTListadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMouseClicked
        ...
        jTdire.setText(jTListado.getValueAt(fila, 2).toString());
        jTtelefono.setText(jTListado.getValueAt(fila, 3).toString());
        jCBdepa.setSelectedItem(jTListado.getValueAt(fila, 4).toString());
