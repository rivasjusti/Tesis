...
import static frminicio.frmvistaclientes.jTListado;
 ...
 * @author Justi
 */
public class frmvistacaja extends javax.swing.JFrame {

    /**
     * Creates new form frmvistacaja
     */
    public frmvistacaja() {
         initComponents();
        mostrar("");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frmcaja1.jTFidCliente.setText(cod);
            frmcaja1.jTFCliente.setText(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistacaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistacaja().setVisible(true);
            }
        });
    }
