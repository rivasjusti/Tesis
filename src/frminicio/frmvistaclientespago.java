 ...
 * @author MartinezJL
 */
public class frmvistaclientespago extends javax.swing.JFrame{

    /**
     * Creates new form frmvistahabitacion
     */
    public frmvistaclientespago() {
        initComponents();
        mostrar("");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
           ...
           valor = jTListado.getValueAt(fila, 1).toString() + " " + jTListado.getValueAt(fila, 2).toString();;
            ...
            frmpago.txtidcliente.setText(cod);
            frmpago.txtclientes.setText(valor);
...
//        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaclientespago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaclientespago().setVisible(true);
            }
        });
    }
