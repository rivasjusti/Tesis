...
public class frmacceso extends javax.swing.JInternalFrame {
    ...
    void mostrar (String buscar){
        try {
            ...
            f_tipoacceso func = new f_tipoacceso();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Accesos.."));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Listado de Acceso"));
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        ...
        vtipoacceso dts = new vtipoacceso();
        f_tipoacceso func = new f_tipoacceso();

        dts.setNombrea(jTFNombre.getText());

        if (accion.equals("guardar")) {
            if(func.insertar(dts)){
                JOptionPane.showMessageDialog(rootPane, "El acceso fue registrado satisfactoriamete!");
                mostrar("");
                inhabilitar();
            }
        }
        else if (accion.equals("editar")) {
            dts.setIdTipoacceso(Integer.parseInt(jTFidtipodoc.getText()));
            if (func.editar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "El acceso fue editado satisfactoriamente!");
                mostrar("");
                inhabilitar();
            }
        }
    ...
    private void jBEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarActionPerformed
        ...
        if (!jTFidtipodoc.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Estas seguro de eliminar el acceso?", "Confirmar", 2);
