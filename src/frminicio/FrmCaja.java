...
//-----------------------------------------------------------------------------------------------
  ...
  void BuscarIngresos(){
    ...
    private void initComponents() {
        ...
        dcFecha.setBounds(120, 25, 120, 20);
        ...
        jButton1.setBounds(250, 10, 530, 50);
        ...
        txtIngreso.setBounds(10, 50, 210, 30);
        ...
        txtCantidad.setBounds(10, 120, 210, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel4.setText("Utilidad bruta:");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 160, 150, 30);
        ...
        txtGanancia.setBounds(10, 190, 210, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 70, 230, 240);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("TOTAL EN CAJA:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(70, 280, 110, 90);
        ...
        txtTotal.setBounds(250, 290, 530, 60);
