...
public class frmfactura extends javax.swing.JInternalFrame{
    ...
    void mostrar (String buscar){
        try {
            ...
            f_tipofactura func = new f_tipofactura();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de factura", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.ABOVE_TOP));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Listado de factura"));
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        ...
        vTipoFactura dts = new vTipoFactura();
        f_tipofactura func = new f_tipofactura();

        dts.setNombrefac(jTFNombre.getText());
        ...
        if (accion.equals("guardar")) {
            ...
            dts.setIdTipoFactura(Integer.parseInt(jTFidtipodoc.getText()));
            if (func.editar(dts)) {
