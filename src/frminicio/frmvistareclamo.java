 ...
 * @author justi
 */
public class frmvistareclamo extends javax.swing.JFrame{

    /**
     * Creates new form frmvistahabitacion
     */
    public frmvistareclamo() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Listado de Reclamos"));
        ...
        jBAgregarHabitacion.setText("Agregar Clientes");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frmreclamos.txtidcliente.setText(cod);
            frmreclamos.txtclientes.setText(valor);
           //frmreclamos.jTFapellido.setText(valor);
            this.dispose();
        }
...
//        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistareclamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistareclamo().setVisible(true);
            }
        });
    }
