 ...
 * @author MartinezJL
 */
public class frmvistamecanico extends javax.swing.JFrame{

    /**
     * Creates new form frmvistahabitacion
     */
    public frmvistamecanico() {
        initComponents();
        mostrar("");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frmreparacion.txtidmecanico.setText(cod);
            frmreparacion.txtmecanico.setText(valor);
...
//        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistamecanico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistamecanico().setVisible(true);
            }
        });
    }
