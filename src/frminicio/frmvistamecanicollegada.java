 ...
 * @author MartinezJL
 */
public class frmvistamecanicollegada extends javax.swing.JFrame{

    /**
     * Creates new form frmvistahabitacion
     */
    public frmvistamecanicollegada() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Listado de mecanico"));
        ...
        jBAgregarHabitacion.setText("Agregar mecanico");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            //valor = jTListado.getValueAt(fila, 1).toString();
            valor = jTListado.getValueAt(fila, 1).toString() + " " + jTListado.getValueAt(fila, 2).toString();;
            
            frmllegada.txtidmecanico.setText(cod);
            frmllegada.txtmecanico.setText(valor);
...
//        form.setAlwaysOnTop(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistamecanicollegada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistamecanicollegada().setVisible(true);
            }
        });
    }
