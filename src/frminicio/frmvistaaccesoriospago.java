...
import static frminicio.frminicio.escritorio;
 ...
 * @author MartinezJL
 */
public class frmvistaaccesoriospago extends javax.swing.JFrame{

    /**
     * Creates new form frmvistahabitacion
     */
    public frmvistaaccesoriospago() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jBAgregarHabitacion.setText("Agregar Accesorios");
    ...
    private void jTListadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTListadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
           ...
           // valor = jTListado.getValueAt(fila, 2).toString() ;
            ...
            frmpago.txtidaccesorios.setText(cod);
            frmpago.txtaccesorios.setText(valor);
...
//        form.setAlwaysOnTop(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaaccesoriospago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaaccesoriospago().setVisible(true);
            }
        });
    }
